...
const NicerHomeScreen = ({navigation}) => {
      ...
      <View style={style.header}>
        <View>
          <View style={{flexDirection: 'row'}}>
            <Text style={{fontSize: 28}}>สวัสดี, คุณ</Text>
        ...
        <Image
          source={require('../assets/pollakit.jpg')}
          //source='http://cold-squid-62.loca.lt/media/images/shopOwner/kekw.jpg'
          //source={TestAPI2.concat(TestAPI3)}
...
export default NicerHomeScreen;
